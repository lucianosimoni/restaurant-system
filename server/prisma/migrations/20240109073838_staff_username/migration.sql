/*
  ...
  - You are about to drop the column `credential` on the `Staff` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "Staff_credential_key";

-- AlterTable
ALTER TABLE "Staff" DROP COLUMN "credential",
